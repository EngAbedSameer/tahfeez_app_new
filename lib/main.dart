            ...
            builder: (c, w) {
              return GetMaterialApp(
                ...
                theme: ThemeData(
                    fontFamily: 'Avenir',
                    colorScheme:
                        ColorScheme.fromSeed(seedColor: Color(0xff45797D))
                    // ColorScheme.fromSwatch().copyWith(
                    //   primary: const Color(
                    //       0xFF00201A), //button text , text field on select border, circuler progress indicator
                    //   secondary: const Color(0xFF797D7E),
                    //   primaryContainer: Colors.green, // CircleAvatar background
                    //   surfaceContainer: const Color.fromARGB(255, 164, 136,
                    //       206), // menu list background, app bar after scroll
                    //   surface: Colors.white,
                    //   error: Colors.redAccent,
                    //   errorContainer: const Color.fromARGB(255, 228, 77, 77),
                    //   inversePrimary: Colors.blue,
                    //   inverseSurface:
                    //       const Color.fromARGB(255, 5, 71, 124), //snackbar
                    //   onInverseSurface: const Color.fromARGB(255, 0, 0, 0),
                    //   onSurface:
                    //       const Color.fromARGB(255, 0, 0, 0), // main text color
                    ...
                    //       255, 0, 250, 25), // text field border color
                    //   shadow: Colors.grey,
                    ...
                    //       136, 210, 11, 11), // app bar actions icon color
                    ...
                    //   surfaceContainerLow:
                    //       Color(0xFFC2E7E1), // button background, card color,
