...
class _StudentProfileState extends State<StudentProfile>
  ...
  Future<List> _getStudentHistory() async {
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Center(child: Text('تاريخ الميلاد: ${stdDate["DOB"]}')),
                        Center(child: Text('الجوال: ${stdDate["phone"]}')),
                        SizedBox(
                          height: 15,
                        ),
                        // Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Text(
                                '15-25',
                                style: TextStyle(
                                    fontSize: 14.sp, color: Colors.teal[200]),
                              ),
                            ],
                          ),
                        ),
                          ...
                          children: [
                            ...
                            Expanded(
                              ...
                              child: Column(
                                // mainAxisAlignment: MainAxisAlignment.center,
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [Text('السنة الدراسية'), Text('4')],
                              ),
                            )),
                            Expanded(
                                child: Container(
